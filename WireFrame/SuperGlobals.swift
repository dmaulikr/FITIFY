...
var excercisePlaylist = [
    ...
    Excercise(name: "Ab Crunch", desc: "Start with kneed a shoulder width apart. Bend both knees as much as possible then spring back up", image: UIImage(named: "s4")!),
    Excercise(name: "Super Jacks", desc: "Start with legs together. Jump and spread your arms then return to the initial position", image: UIImage(named: "s5")!),
]

var alternateExcercises = [
    Excercise(name: "Calf Raise", desc: "Push up to your tip toes", image: UIImage(named: "s6")!),
    Excercise(name: "Wall Squat", desc: "Sit against the wall with legs at 90 degrees and hold", image: UIImage(named: "s7")!),
    Excercise(name: "Front Squat", desc: "Place the bar on your shoulderblades and perform a squat", image: UIImage(named: "s8")!),
